...
class GotoPoint():
    def __init__(self):
        rospy.init_node('map_navigation_kim2', anonymous=False)
        rospy.on_shutdown(self.shutdown)
        self.cmd_vel = rospy.Publisher('tb3_2/cmd_vel', Twist, queue_size=5)
        self.odom_sub = rospy.Subscriber('/tb3_2/amcl_pose', PoseWithCovarianceStamped, self.callback)
        # self.num_list = rospy.Subscriber('my_topic', Float64MultiArray, self.callback1)
        self.coord_1_x_sub = rospy.Subscriber('coord_3_x', Float64MultiArray, self.callback_x)
        self.coord_1_y_sub = rospy.Subscriber('coord_3_y', Float64MultiArray, self.callback_y)
